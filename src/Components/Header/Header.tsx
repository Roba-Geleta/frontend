          ...
          <div className="flex flex-wrap w-full">
            {navItems.map((item) => (
              <NavLink
                ...
                to={item.to}
                className={({ isActive }) =>
                  `flex-1 flex items-center justify-center px-2 sm:px-4 py-2 m-1 border rounded-md text-xs sm:text-sm font-medium text-gray-700 dark:text-gray-200 hover:text-blue-500 dark:hover:text-blue-400 transition-colors ${
                    isActive
