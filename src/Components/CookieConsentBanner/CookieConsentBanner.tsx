...
const CookieConsentBanner: React.FC<CookieConsentBannerProps> = ({
  ...
  return (
    <div className="absolute bottom-0 w-full bg-gray-100 dark:bg-gray-800 border-t border-gray-300 dark:border-gray-700 p-4 flex flex-col sm:flex-row items-center justify-between z-50">
